...
export class RevenuesPage implements OnInit {
  ...
  async loadRevenues() {
    API
      .post(this.apiName, '/property-revenues', {})
      .then(response => {
  ...
  async reloadConnections(callback) {
  ...
  async reloadRevenues() {
    this.revenues = new Array();
    this.backupRevenues = new Array();
    API
      .post(this.apiName, '/property-revenues', {})
      .then(response => {
        var dbRevenues = response.revenues;
  ...
  async openRevenueDetails(index: number) {
    ...
    revenueDetailsModal.onDidDismiss().then((dismissed) => {
      this.reloadConnections(() => this.reloadRevenues());
  });
...
async openAddRevenueForm() {
  ...
  addRevenueFormPage.onDidDismiss().then((dismissed) => {
    this.reloadConnections(() => this.reloadRevenues());
});
