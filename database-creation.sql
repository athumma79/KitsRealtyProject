...
CREATE TABLE CONTRACTOR (
    ...
    END_DATE DATE,
    COMPANY VARCHAR(50),
    CONTRACTOR_FOLDER_PATH VARCHAR(200) NOT NULL,
...
CREATE TABLE TAX (
    ...
    GOVERNMENT_TAX_ID VARCHAR(50) NOT NULL UNIQUE,
    USER_COGNITO_ID VARCHAR(50) NOT NULL UNIQUE,
    TAX_FOLDER_PATH VARCHAR(200) NOT NULL,
...
CREATE TABLE PROPERTY (
    ...
    NOTES VARCHAR(200),
    PROPERTY_FOLDER_PATH VARCHAR(200) NOT NULL,
...
CREATE TABLE NEARBY_PROPERTY (
    NEARBY_PROPERTY_ID INT PRIMARY KEY AUTO_INCREMENT,
